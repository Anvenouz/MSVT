                ...
                <div class="carousel slide carousel-fade carousel-max_sup" id="carousel-activities" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="img/img_scolaire/carousel/slide1.jpg" alt="slide 1">
                        </div>
                        <?php for ($i = 2; $i < 4; $i++) { ?>
                            <div class="carousel-item">
                                <img class="d-block w-100" src="img/img_scolaire/carousel/slide<?php echo $i; ?>.jpg" alt="slide <?php echo $i; ?>">
                            </div>
                        <?php } ?>
                    </div>
                </div>
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <th class="th-tarif">Demi-journée<sup>
                                                    <a href="javascript:;" data-toggle="tooltip" title="9h-12h ou 13h-16h"><img src="img/icon/question.png" width="12" alt="tooltip"></a></sup></th>
    ...
    <div class="block-90">
        ...
        <div class="card-resp card card-body reveal-2">
            ...
            <div class="filter_selector" id="scolaire-filter">
                <button class="button-filter-scolaire hidden-resp" id="btn-all" onclick="filterSelection('all')">Toutes les activités</button><button class="button-filter-scolaire" id="btn-maternelles" onclick="filterSelection('maternelles')">Maternelles</button><button class="button-filter-scolaire" id="btn-primaires" onclick="filterSelection('primaires')">Primaires</button><button class="button-filter-scolaire" id="btn-secondaires" onclick="filterSelection('secondaires')">Secondaires</button>
            </div>
            <!-- Maternelles -->
                ...
                <div class="column maternelles">
                    ...
                    <div class="block-flex reveal">
                        <div class="frame-effect-lt rotate-lt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/mat/mat_picpic.jpg" alt="animation maternelles 1">
                        </div>
                        <div class="mr90">
                    ...
                    <div class="block-flex reveal">
                        <div class="ml90 bg-radial-effect">
                            <div class="block-scol-icon-container reveal-2">
                                ...
                                <div class="scolaire-icon-flex reveal-2">
                                    ...
                                    <div title="Durée de l'activité" class="block-scolaire-item-img">
                                        <img src="img/icon/icon-scolaire/icon3.png" alt="time icon">
                                        <p class="scolaire-sub-item">1h30</p>
                                    </div>
                                    <div title="Activité intérieure et/ou extérieure" class="block-scolaire-item-img">
                                        <img src="img/icon/icon-scolaire/icon4.png" alt="int/ext icon">
                                        <p class="scolaire-sub-item">int./ext.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="frame-effect-rt rotate-rt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/mat/mat_graine_plante.jpg" alt="animation maternelles 2">
                        </div>
                    </div>
                    <hr class="hr1 my-5">
                    <!-- 3. Eau -->
                    <div class="block-flex reveal">
                        <div class="frame-effect-lt rotate-lt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/mat/mat_eau.jpg" alt="animation maternelles 3">
                        </div>
                    ...
                    <div class="block-flex reveal">
                        ...
                        <div class="frame-effect-rt rotate-rt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/mat/mat_mare.jpg" alt="animation maternelles 4">
                        </div>
                    </div>
                    <hr class="hr1 my-5">
                    <!-- 5. Sol -->
                    <div class="block-flex reveal">
                        <div class="frame-effect-lt rotate-lt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/mat/mat_faune_sol.jpg" alt="animation maternelles 5">
                        </div>
                        <div class="mr90 bg-radial-effect">
                            <div class="block-scol-icon-container reveal-2">
            ...
            <section class="row-scolaire section-80 w100-resp">
                <div class="column primaires">
                    ...
                    <div class="block-flex reveal">
                        ...
                        <div class="frame-effect-rt rotate-rt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri1.jpg" alt="animation primaire 1">
                        </div>
                    </div>
                    <hr class="hr1 my-5">
                    <!-- 2. Eau -->
                    <div class="block-flex reveal">
                        <div class="frame-effect-lt rotate-lt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri_etude_eau.jpg" alt="animation primaire 2">
                        </div>
                        <div class="mr90 bg-radial-effect">
                            <div class="block-scol-icon-container  reveal-2">
                    ...
                    <div class="block-flex reveal">
                        ...
                        <div class="frame-effect-rt rotate-rt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri_mare.jpg" alt="animation primaire 3">
                        </div>
                    </div>
                    <hr class="hr1 my-5">
                    <!-- 4. Sol -->
                    <div class="block-flex reveal">
                        <div class="frame-effect-lt rotate-lt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri_faune_sol.jpg" alt="animation priamire 4">
                        </div>
                        <div class="mr90 bg-radial-effect">
                            <div class="block-scol-icon-container  reveal-2">
                                <h2 class="block-title mb10 text-center reveal-2">La faune du sol</h2>
                    ...
                    <div class="block-flex relative reveal">
                        <div class="ml90 bg-radial-effect">
                            <div class="block-scol-icon-container  reveal-2">
                                ...
                                <img src="img/icon/icon-scolaire/img-demi.png" class="img-demi-ml reveal-1" alt="formule 3h">
                                <div class="scolaire-icon-flex reveal-2">
                                    <div title="Niveaux scolaire(s) concerné(s)" class="block-scolaire-item-img">
                                        <img src="img/icon/icon-scolaire/icon1.png" alt="class icon">
                        ...
                        <div class="frame-effect-rt rotate-rt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri_monde_veg.jpg" alt="animation primaire 5">
                        </div>
                    </div>
                    <hr class="hr1 my-5">
                    ...
                    <div class="block-flex relative reveal">
                        <div class="frame-effect-lt rotate-lt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri_plante_insecte.jpg" alt="animation primaires 6">
                        </div>
                        <div class="mr90 bg-radial-effect">
                            <div class="block-scol-icon-container reveal-2">
                                <h2 class="block-title mb10 text-center reveal-2" id="demi-plante">Arbres et vie souterraine</h2>
                                <img src="img/icon/icon-scolaire/img-demi.png" class="img-demi-mr reveal-1" alt="formule 3h">
                                <div class="scolaire-icon-flex reveal-2">
                                    <div title="Niveaux scolaire(s) concerné(s)" class="block-scolaire-item-img">
                                        <img src="img/icon/icon-scolaire/icon1.png" alt="class icon">
                                        <p class="scolaire-sub-item">P1 - P6</p>
                    ...
                    <div class="block-flex reveal">
                        ...
                        <div class="frame-effect-rt rotate-rt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri_chauve_souris.jpg" alt="animation primaire 7">
                        </div>
                    </div>
                    <hr class="hr1 my-5">
                    <!-- 8. Tri et recyclage -->
                    <div class="block-flex reveal">
                        <div class="frame-effect-lt rotate-lt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri_tri.jpg" alt="animation primaires 8">
                        </div>
                        <div class="mr90 bg-radial-effect">
                            <div class="block-scol-icon-container  reveal-2">
                    ...
                    <div class="block-flex relative reveal">
                        ...
                        <div class="frame-effect-rt rotate-rt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri_decouverte_oiseaux.jpg" alt="animation primaire 9">
                        </div>
                    </div>
                    <hr class="hr1 my-5">
                    ...
                    <div class="block-flex reveal">
                        <div class="frame-effect-lt rotate-lt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri_empreinte.jpg" alt="animation primaires 10">
                        </div>
                        <div class="mr90 bg-radial-effect">
                            <div class="block-scol-icon-container reveal-2">
                    ...
                    <div class="block-flex reveal">
                        ...
                        <div class="frame-effect-rt rotate-rt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri_becs_pattes.jpg" alt="animation primaire 11">
                        </div>
                    </div>
                    <hr class="hr1 my-5">
                    ...
                    <div class="block-flex reveal">
                        <div class="frame-effect-lt rotate-lt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri_oiseaux_carriere.jpg" alt="animation primaires 12">
                        </div>
                        <div class="mr90 bg-radial-effect">
                            <div class="block-scol-icon-container  reveal-2">
                    ...
                    <div class="block-flex relative reveal">
                        ...
                        <div class="frame-effect-rt rotate-rt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri_habitant_mare.jpg" alt="animation primaire 11">
                        </div>
                    </div>
                    <hr class="hr1 my-5">
                    ...
                    <div class="block-flex relative reveal">
                        <div class="frame-effect-lt rotate-lt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri_nature_preservation.jpg" alt="animation primaires 12">
                        </div>
                        <div class="mr90 bg-radial-effect">
                            <div class="block-scol-icon-container  reveal-2">
                    ...
                    <div class="block-flex relative reveal">
                        ...
                        <div class="frame-effect-rt rotate-rt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri_univers-eau.jpg" alt="animation primaire 11">
                        </div>
                    </div>
                    <hr class="hr1 my-5">
                    <!-- 16. Les phasmes -->
                    <div class="block-flex relative reveal">
                        <div class="frame-effect-lt rotate-lt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri_phasme.jpg" alt="animation primaires 12">
                        </div>
                        <div class="mr90 bg-radial-effect">
                            <div class="block-scol-icon-container reveal-2">
            ...
            <section class="row-scolaire w100-resp section-80">
                <div class="column secondaires">
                    ...
                    <div class="block-flex reveal">
                        ...
                        <div class="frame-effect-rt rotate-rt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/sec/sec_visite_carriere.jpg" alt="animation secondaire 3">
                        </div>
                    </div>
                    <hr class="hr1 my-5">
                    ...
                    <div class="block-flex relative reveal" id="section-usine">
                        <div class="frame-effect-lt rotate-lt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/sec/sec_usine.jpg" alt="animation secondaire 1">
                        </div>
                        <div class="mr90 bg-radial-effect">
                            <div class="block-scol-icon-container  reveal-2">
                    ...
                    <div class="block-flex reveal">
                        ...
                        <div class="frame-effect-rt rotate-rt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/sec/sec_pollution.jpg" alt="animation secondaire 9">
                        </div>
                    </div>
                    <hr class="hr1 my-5">
                    <!-- 3. Expo biodiversité -->
                    <div class="block-flex reveal">
                        <div class="frame-effect-lt rotate-lt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/pri/pri1.jpg" alt="animation secondaire 2">
                        </div>
                        <div class="mr90 bg-radial-effect">
                            <div class="block-scol-icon-container  reveal-2">
                    ...
                    <div class="block-flex reveal relative">
                        ...
                        <div class="frame-effect-rt rotate-rt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/sec/sec_bota.jpg" alt="animation secondaire 9">
                        </div>
                    </div>
                    <hr class="hr1 my-5">
                    ...
                    <div class="block-flex reveal">
                        <div class="frame-effect-lt rotate-lt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/sec/sec_interaction.jpg" alt="animation primaires 6">
                        </div>
                        <div class="mr90 bg-radial-effect">
                            <div class="block-scol-icon-container  reveal-2">
                    ...
                    <div class="block-flex reveal">
                        ...
                        <div class="frame-effect-rt rotate-rt reveal-1">
                            <img class="block-img-scolaire" src="img/img_scolaire/sec/sec_DD.jpg" alt="animation secondaire 9">
                        </div>
                    </div>
                </div>
            </section>
...
<script src="js/filter_scolaire.js"></script>
</body>
