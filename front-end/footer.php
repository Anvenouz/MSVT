<footer class="text-center text-lg-start text-muted pt-4">
    <div class="container container-footer text-center text-md-start">
        <div class="row row-footer">
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 resp-center mb-65-resp">
                <img src="./img/logo/logo_v2.1.png" class="mb20" width="170" alt="logo MSVT">
                ...
                <p class="footer-info footer-icon4">
                    <a href="https://www.msvt.be">https://www.msvt.be</a>
                </p>
            ...
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mb-4">
                ...
                <p class="footer-info about center"><a href="historique">Qui sommes-nous ?</a></p>
                <p class="footer-info about center"><a href="https://goo.gl/maps/PGNfeRjG91UcMExN9">Nous localiser</a></p>
                <p class="footer-info about center"><a href="contact">Aide et support</a></p>
                <p class="footer-info about center"><a href="privacy">Privacy policy</a></p>
                <p class="footer-info about center"><a href="terms">Terms of use</a></p>
            </div>
            <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mb-3">
                ...
                <div class="logo-partners text-center text-uppercase">
                    ...
                    for ($i = 1; $i < 7; $i++) {
                        echo '<a href="' . $urls[$i - 1] . '" target="_blank"><img class="logo-part-icon" src="./img/logo/Logo_partners/logo_part_' . $i . '.png" width="80px" alt="logo part' . $i . '"></a>';
                    }
                    ?>
                </div>
            </div>
    ...
    <div class="text-center p-2 copyright">
        ...
        <a class="text-reset" href="https://msvt.be/">ASBL - Maison des Sciences de la Vie et de la Terre</a>
    </div>
</footer>
<script>
