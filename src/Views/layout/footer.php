    ...
    <div class="container container-footer text-center text-md-start">
        <div class="row row-footer">
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4 resp-center mb-65-resp">
                <img src="/assets/img/logo/logo_v2.1.png" class="mb20" width="170" alt="logo MSVT">
...
<?php
                ...
                for ($i = 1; $i < 7; $i++) {
                    echo '<a href="' . $urls[$i - 1] . '" target="_blank"><img class="logo-part-icon" src="/assets/img/logo/Logo_partners/logo_part_' . $i . '.png" width="80px" alt="logo part' . $i . '"></a>';
                }
?>
                </div>
            </div>
    ...
    <div class="text-center p-2 copyright">
        ...
        <a class="text-reset" href="/">ASBL - Maison des Sciences de la Vie et de la Terre</a>
    </div>
</footer>
<script>
