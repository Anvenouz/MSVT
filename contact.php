...
<section class="section-100 no-pt-resp no-pb-resp bg-linear">
    ...
    <div class="block-80 w100-resp reveal">
        <div class="form-contact-flex" id="contact-form">
            ...
            <div class="block-img-contact">
                <img src="img/img_contact/contact-img.jpg" class="hidden-resp" alt="img contact">
            </div>
            <!-- Formulaire -->
    ...
    <div class="block-85 block-index-themes mt50 reveal-3 hidden-resp">
        <img src="img/logo/logo_v2.1.png " alt="logo MSVT" width="180" id="contact-img">
        ...
        <button type="button" class="button-main mt20 reveal-4" onclick="window.location.href='contact'">Nous contacter</button>
        <!-- 3 Blocs Infos  -->
