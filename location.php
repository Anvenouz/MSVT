                ...
                <div class="carousel slide carousel-fade carousel-max" data-ride="carousel">
                    <div class="carousel-inner block-location-img">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="img/img_carousel/location/slide1.jpg" alt="slide 1">
                        </div>
                        <?php
                        for ($i = 2; $i < 8; $i++) {
                            echo '<div class="carousel-item"><img class="d-block w-100" src="img/img_carousel/location/slide' . $i . '.jpg" alt="slide ' . $i . '">
                            </div>';
                        }
                        ?>
                    </div>
                                    ...
                                    <table class="mt-2">
                                        ...
                                        <tr>
                                            ...
                                            <td class="td-tarif">Sandwichs<sup>
                                                    <a href="javascript:;" data-toggle="tooltip" title="Plusieurs sortes de sandwichs garnis"><img src="img/icon/question.png" width="12" alt="tooltip"></a></sup></td>
                                        ...
                                        <tr>
                                            <td class="td-tarif" rowspan="2">Supplément (visite guidée)<sup>
                                                    <a href="javascript:;" data-toggle="tooltip" title="Visite guidée dans anciennes carrières. Groupe de 15 maximum"><img src="img/icon/question.png" width="12" alt="tooltip"></a></sup></td>
    ...
    <div class="block-90 reveal" id="location-equip">
        <div class="section-flex-row reveal-2">
            ...
            <div class="block-3x-flex hidden-resp reveal-3" id="block-salle">
                <img class="icon-theme-loc" src="img/icon/icon-theme/loc1.png" alt="icone location salle" width="110">
                ...
                <div class="accordion" id="accordionLocation1">
                    <div class="accordion-item no-bg no-border">
                        ...
                        <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionLocation1">
                            <div class="accordion-body">
                                <img src="img/img_carousel/location/slide1.jpg" class="block-location-accordion-img" alt="location collapse 1">
                    ...
                    <div class="accordion-item no-bg no-border mt-2">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionLocation1">
                            <div class="accordion-body">
                                <img src="img/img_carousel/location/slide2.jpg" class="block-location-accordion-img" alt="location collapse 2">
                                <ul class="block-list-location reveal-3">
                                    <li>Environ 80m²</li>
                    ...
                    <div class="accordion-item no-bg no-border mt-2">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionLocation1">
                            <div class="accordion-body">
                                <img src="img/img_carousel/location/slide6.jpg" class="block-location-accordion-img" alt="location collapse 3">
                                <ul class="block-list-location reveal-3">
                                    <li>Environ 50m²</li>
            ...
            <div class="block-3x-flex hidden-resp reveal-3" id="block-equip">
                <img class="icon-theme-loc" src="img/icon/icon-theme/loc2.png" alt="icone équipement" width="110">
            ...
            <div class="block-3x-flex reveal-3" id="block-question">
                <img class="icon-theme-loc" src="img/icon/icon-theme/loc3.png" alt="icone question" width="110">
                ...
                <div class="button-activity-90 mt10-resp">
                    <button type="button" class="button-main reveal-4" onclick="window.location.href='reservation'">Réservez</button>
                    <button type="button" class="button-secondary reveal-4" id="button-contact-location" onclick="window.location.href='contact'">Nous contacter</button>
                </div>
            </div>
        </div>
    </div>
